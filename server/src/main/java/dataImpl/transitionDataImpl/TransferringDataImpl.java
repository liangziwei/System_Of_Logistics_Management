...
public class TransferringDataImpl implements TransferringDataService{
	...
	public List<TransferringPO> GetTransferringInfoDT(String date) {
		...
		alltransferringPO.add(new TransferringPO("2015-10-11","017101000000127",LoadingType.PLANE,
				"139010001","北京", "南京", "茗柯", "3", alldeliveryid1));
		alltransferringPO.add(new TransferringPO("2015-10-11","017101000100127",LoadingType.TRAIN,
