...
public class DateChooser extends JPanel {
	...
	private class JP1 extends JPanel {
		...
		private void updateDate() {
			center.setText(select.get(Calendar.YEAR) + "-" + (select.get(Calendar.MONTH) + 1) + "-"+(select.get(Calendar.DAY_OF_MONTH)));
		}
	}
