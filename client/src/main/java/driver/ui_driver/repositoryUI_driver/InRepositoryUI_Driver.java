...
public class InRepositoryUI_Driver {
	public static void main(String[] args) {
		...
		while (go) {
			...
			int input = s.nextInt();
			switch(input){
			case 1:String add = inRepositoryBLService.addInRepositoryFormBL(new InRepositoryVO("1110101023","2015-10-13", "北京",AreaCodeType.PLANEAREA,"004","012","042",true));
			if(add.equals("ture")){
			...
			break;
			case 2:String modify = inRepositoryBLService.modifyInRepositoryFormBL(new InRepositoryVO("1110101023","2015-10-13", "北京",AreaCodeType.PLANEAREA,"004","012","042",true));
